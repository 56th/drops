...
{
    DROPS::MatDescCL A_P1, A_P1_stab, B_P1P1,Omega_P1P1, C_P1, CT_P1, M_P1, D_P1, S_P1, L_P1P1, L_P1P1_stab, Schur_P1, Schur_P1_stab,Schur_normalP1_stab;
    BndDataCL<Point3DCL> bb(0);
    A_P1.SetIdx( &ifaceVecP1idx, &ifaceVecP1idx);
    A_P1_stab.SetIdx( &ifaceVecP1idx, &ifaceVecP1idx);
    C_P1.SetIdx( &ifaceVecP1idx, &ifaceVecP1idx);
    B_P1P1.SetIdx( &ifaceP1idx, &ifaceVecP1idx);
    Omega_P1P1.SetIdx( &ifaceP1idx, &ifaceVecP1idx);
    M_P1.SetIdx( &ifaceVecP1idx, &ifaceVecP1idx);
    D_P1.SetIdx( &ifaceVecP1idx, &ifaceVecP1idx);
    ...
    std::tuple<instat_vector_fun_ptr, double, double> normalErrors = { nullptr, 0., 0. };
    SetupStokesIF_P2P1(MG, &A_P2, &A_P2_stab, &B_P1P2, &M_P2, &S_P2, &Schur_P2, &Schur_P2_stab, &Schur_P2_normal_stab, lset, fullgrad, "inconsistent", normalErrors);
