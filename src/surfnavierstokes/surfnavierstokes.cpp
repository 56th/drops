...
//         		SetupStokesIF_P1P1(mg, &A, &A_stab, &B, &Omega, &N, &NT, &M, &D, &S,  &L, &L_stab, &Schur, &Schur_stab, &Schur_normal_stab, lset.Phi, lset.GetBndData(), v_aux, vbnd, fullgrad);
...
//         			SetupStokesIF_P1P1(mg, &A, &A_stab, &B, &Omega, &N, &NT, &M, &D, &S, &L, &L_stab, &Schur, &Schur_stab, &Schur_normal_stab, lset.Phi, lset.GetBndData(), v_old, vbnd, fullgrad);
