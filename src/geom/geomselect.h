...
void BuildBoundaryData(const MultiGridCL* mgp, BoundaryT* &bnddata,
                       const std::string& bnd_type, const std::string& bnd_funcs, MatchFunction periodic_match = 0, std::string* per_funcs = 0);

template< class BoundaryT>
void BuildBoundaryData(const MultiGridCL* mgp, BoundaryT* &bnddata,
                       const ParamCL &P, MatchFunction periodic_match = 0, std::string* per_funcs = 0);
