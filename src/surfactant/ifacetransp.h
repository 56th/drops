...
void SetupStokesIF_P2P1      ( const MultiGridCL& MG_, MatDescCL* A_P2, MatDescCL* A_P2_stab, MatDescCL* B_P1P2, MatDescCL* M_P2, MatDescCL* S_P2, MatDescCL* M_ScalarP1, MatDescCL* M_ScalarP1_stab, MatDescCL* A_ScalarP1_stab, const LevelsetP2CL& lset, bool fullgrad);
