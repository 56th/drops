...
enum SPcE {
    ISBBT_SPC= 1, ISBBT_Stab_SPC = 11, MinComm_SPC= 2, ISPre_SPC= 3, ISMG_SPC= 7, BDinvBT_SPC= 5, SIMPLER_SPC=8, MSIMPLER_SPC=9, VankaSchur_SPC= 4, VankaBlock_SPC=6, ISNonlinear_SPC=10
};
...
StokesSolverFactoryCL<StokesT, ProlongationVelT, ProlongationPT>::
    ...
    : base_(Stokes, P),
        ...
        bbtis_Stab_pc_    ( &Stokes_.B.Data.GetFinest(), &Stokes_.prJ.Data.GetFinest(), &Stokes_.prM.Data.GetFinest(), &Stokes_.M.Data.GetFinest(), Stokes_.pr_idx.GetFinest(), kA_, kM_, P.get<double>("Stokes.PcSTol"), P.get<double>("Stokes.PcSTol") /* enable regularization: , 0.707*/),
