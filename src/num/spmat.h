...
/// \brief Compute the linear combination of five sparse matrices.
template <typename T>
SparseMatBaseCL<T>& SparseMatBaseCL<T>::LinComb (double coeffA, const SparseMatBaseCL<T>& A,
                                                 double coeffB, const SparseMatBaseCL<T>& B,
                                                 double coeffC, const SparseMatBaseCL<T>& C,
...
/// \brief Compute the linear combination of six sparse matrices.
///  sparse matrices.
template <typename T>
SparseMatBaseCL<T>& SparseMatBaseCL<T>::LinComb (double coeffA, const SparseMatBaseCL<T>& A,
                                                 double coeffB, const SparseMatBaseCL<T>& B,
                                                 ...
                                                 double coeffD, const SparseMatBaseCL<T>& D,
                                                 double coeffE, const SparseMatBaseCL<T>& E,
                                                 double coeffF, const SparseMatBaseCL<T>& F)
{
    SparseMatBaseCL<T> tmp;
    tmp.LinComb( coeffA, A, coeffB, B, coeffC, C, coeffD, D, coeffE, E);
    return this->LinComb( 1.0, tmp, coeffF, F);
}
/// \brief Compute the linear combination of seven sparse matrices.
///  sparse matrices.
template <typename T>
SparseMatBaseCL<T>& SparseMatBaseCL<T>::LinComb (double coeffA, const SparseMatBaseCL<T>& A,
                                                 double coeffB, const SparseMatBaseCL<T>& B,
                                                 ...
                                                 double coeffE, const SparseMatBaseCL<T>& E,
                                                 double coeffF, const SparseMatBaseCL<T>& F,
                                                 double coeffG, const SparseMatBaseCL<T>& G)
{
    SparseMatBaseCL<T> tmp;
    tmp.LinComb( coeffA, A, coeffB, B, coeffC, C, coeffD, D, coeffE, E, coeffF,F);
    return this->LinComb( 1.0, tmp, coeffG, G);
}
/// \brief Compute the linear combination of seven sparse matrices.
///  sparse matrices.
template <typename T>
SparseMatBaseCL<T>& SparseMatBaseCL<T>::LinComb (double coeffA, const SparseMatBaseCL<T>& A,
                                                 ...
                                                 double coeffF, const SparseMatBaseCL<T>& F,
                                                 double coeffG, const SparseMatBaseCL<T>& G,
                                                 double coeffH, const SparseMatBaseCL<T>& H)
{
    SparseMatBaseCL<T> tmp;
    tmp.LinComb( coeffA, A, coeffB, B, coeffC, C, coeffD, D, coeffE, E, coeffF,F,coeffG,G);
    return this->LinComb( 1.0, tmp, coeffH, H);
}
