...
Die M_p-Komplementmatrix wird durch einen SSOR-Schritt mit der
...
\subsubsection{M_p-Verfahren}
Die M_p-Komplementmatrix $S=BA^{-1}B^T$ wird in Drops durch die Klasse
...
Damit kann das M_p-Verfahren in \prg{SchurSolverCL} und \prg{PSchurSolverCL} so
darstellen:
\begin{enumerate}
